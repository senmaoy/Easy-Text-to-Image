...
|    Pre-print Paper    |  Method  |  Conference  |  Code |  IS(bird) | FID(bird)|IS(COCO) |FID(COCO)|
|  :---------  | :------:  | :------: | :------: |:------: |:------: |:------: |:------: |
| [DF-GAN](https://arxiv.org/pdf/2111.11821.pdf) | NCC | Arxiv 2021 | [Pytorch](https://github.com/Hzzone/DeepClustering.SSL) | IS(bird) | FID(bird)|IS(COCO) |FID(COCO)|
